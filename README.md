...
- clone the Property Oracle repo.
- Set up Property oracle chain and get it running. Directions are given here -> https://github.com/thewoodfish/property-oracle-node
- Run `npm install`
- Start interacting with Property Oracle!
